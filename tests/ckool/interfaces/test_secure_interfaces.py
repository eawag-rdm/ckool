...
def test_secure_interface_init(secure_interface_input_args):
    ...
    with pytest.raises(FileNotFoundError):
        SecureInterface(host="FakeHost", username="SomeUserName", ssh_key="/does/not/exist/id_rsa")

    with pytest.raises(ValueError):
        SecureInterface(host="FakeHost", username="SomeUserName")
        SecureInterface(host="FakeHost", username="SomeUserName", password="abs", ssh_key="ass")
        SecureInterface(host="FakeHost", username="SomeUserName", password="abs", ssh_key="ass", passphrase="dsfs")
        SecureInterface(host="FakeHost", username="SomeUserName", password="abs", passphrase="ass")
